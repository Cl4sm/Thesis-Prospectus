...
%  SECTION: Background
% ============================================================
% Background content has been moved to Chapter~\ref{ch:background}.
% Firmware types, motivating example, vulnerability analysis, and threat model
% are now in the shared Background chapter.
