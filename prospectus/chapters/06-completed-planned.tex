...
Through these works it has been demonstrated that complete and scalable software vulnerability analysis requires a combination of approaches which complement each other's strengths and weaknesses.
We have developed several different approaches for combining static analysis, symbolic execution, and LLMs to achieve this goal, and the proposed work in Chapter~\ref{ch:proposed} continues in this direction by combining static analysis with directed symbolic execution to validate vulnerability candidates at scale. 
...
\paragraph{Planned work.} Regarding the direction of the project discussed in Chapter~\ref{ch:proposed}, I have completed a working prototype of the directed symbolic execution system.
