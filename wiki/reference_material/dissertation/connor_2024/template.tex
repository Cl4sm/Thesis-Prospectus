...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% https://github.com/GarenSidonius/ASU-Dissertation-Template
% Fixed using https://github.com/GarenSidonius/ASU-Dissertation-Template/issues/40
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Preamble
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newcommand{\pwncollege}[0]{\texttt{pwn.college}\xspace}
\newcommand{\pwn}[0]{\texttt{PWN}\xspace}
\newcommand{\dojo}[0]{\texttt{DOJO}\xspace}
\newcommand{\sensai}[0]{\texttt{SENSAI}\xspace}

\newcommand{\paper}[0]{chaper\xspace}
\newcommand{\tinysection}[1]{\section{#1}}
\newcommand{\tinysubsection}[1]{\subsection{#1}}
\newcommand{\tinysubsubsection}[1]{\subsubsection{#1}}
\newcommand{\maybevspace}[1]{}

\definecolor{shadecolor}{rgb}{0.9, 0.9, 0.9}
\renewenvironment{shaded}{
  \def\FrameCommand{\fboxsep=0.5\FrameSep \colorbox{shadecolor}}
  \vspace{-0.5em}
  \MakeFramed {\advance\hsize-\width \FrameRestore\FrameRestore}
  % \vspace{-0.5em} % Adjust this value for space above
}{%
  % \vspace{-0.5em} % Adjust this value for space below
  \endMakeFramed
  \vspace{-0.5em}
}
\newcommand{\surveyquote}[1]{\begin{shaded}\textit{"#1"} \hspace*{\fill} \textcolor{gray}{\small{\mbox{\raggedleft Student Feedback}}}\end{shaded}}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Title page, input
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\listadd{\titlelines}%
  {Hacking the Learning Curve}                  %<Enter the title of the dissertation
\listadd{\titlelines}%
  {Effective Cybersecurity Education at Scale}  % If you want to
                                        %   split the title across lines,
                                        %   use another \listadd command for the
                                        %   second line
\newcommand*\Author{Connor David Nelson}%<Enter your name; must match official transcript
...
\newcommand*\defdate{February 2024}     %<Give month (written out fully) and year of
                                        %   the oral defense
\listadd{\committeechair}{Yan Shoshitaishvili} %<Enter committee chair name; use \listadd for
\listadd{\committeechair}{Adam Doupé}   %   for additional names
\newcommand*{\chairlabel}{Co-Chair}     %<If you have co-chairs, replace this text with
                                        %   'Co-Chair'
\listadd{\committeemember}{Ruoyu Wang}  %<Enter committee member names; use \listadd for
\listadd{\committeemember}{Tiffany Bao} %   additional names
\listadd{\committeemember}{Giovanni Vigna} %   additional names
...
\else 									                % If xetex or luatex
  ...
  %
%   \setmainfont{EBGaramond}[           %<Set the main font; make sure the font is correct
...
\newcommand{\bibfilename}{%             %<Enter the name of the *.bib file containing the
  bibliography%                         %   reference information for sources cited in
...
\input{content/dissertation/abstract}   %<Enter the name of the .tex file containing your
...
% \input{content/dissertation/dedication} %<Enter the name of the .tex file containing your
%                                         %   your dedication or omit this line and type in
%                                         %   your dedication here.

\chapter*{Acknowledgments}              %~Acknowledgments are optional
\input{content/dissertation/acknowledgments} %<Enter the name of the .tex file containing your
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mainmatter
\input{content/dissertation/introduction}
\clearpage
\input{content/dissertation/pwn}
\clearpage
\input{content/dissertation/dojo}
\clearpage
\input{content/dissertation/sensai}
\clearpage
\input{content/dissertation/pwncollege}
\clearpage
\input{content/dissertation/future}
\clearpage
