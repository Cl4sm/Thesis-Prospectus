...
<svg id="ag-diagram" viewBox="0 0 1050 440" style="width:100%; display:block; margin: 0 auto;" xmlns="http://www.w3.org/2000/svg">
  <defs>
  ...
  <g id="ag-base" style="opacity:0;">
    ...
    <text x="140" y="50" font-size="18.7" font-weight="bold" text-anchor="middle" fill="#1565C0" font-family="Arial, sans-serif">Scanner</text>
    <text x="140" y="72" font-size="14" text-anchor="middle" fill="#666" font-family="Arial, sans-serif">LLM + static analysis</text>

    <!-- Fuzzer -->
    <rect x="285" y="20" width="220" height="70" rx="6" fill="#f5f5f5" stroke="#FF9800" stroke-width="2.5"/>
    <text x="395" y="50" font-size="18.7" font-weight="bold" text-anchor="middle" fill="#E65100" font-family="Arial, sans-serif">Fuzzer</text>
    <text x="395" y="72" font-size="14" text-anchor="middle" fill="#666" font-family="Arial, sans-serif">Coverage + grammar-guided</text>

    <!-- RCA -->
    <rect x="540" y="20" width="220" height="70" rx="6" fill="#f5f5f5" stroke="#4CAF50" stroke-width="2.5"/>
    <text x="650" y="50" font-size="18.7" font-weight="bold" text-anchor="middle" fill="#2E7D32" font-family="Arial, sans-serif">Root Cause Analysis</text>
    <text x="650" y="72" font-size="14" text-anchor="middle" fill="#666" font-family="Arial, sans-serif">Crash-to-code correlation</text>

    <!-- Patcher -->
    <rect x="795" y="20" width="220" height="70" rx="6" fill="#f5f5f5" stroke="#8C1D40" stroke-width="2.5"/>
    <text x="905" y="50" font-size="18.7" font-weight="bold" text-anchor="middle" fill="#8C1D40" font-family="Arial, sans-serif">Patcher</text>
    <text x="905" y="72" font-size="14" text-anchor="middle" fill="#666" font-family="Arial, sans-serif">LLM-generated fix + validation</text>

    <!-- Analysis Graph band (empty) -->
    <rect x="30" y="155" width="985" height="45" rx="6" fill="#F8EEF1" stroke="#8C1D40" stroke-width="2"/>
    <text x="525" y="183" font-size="18.7" font-weight="700" text-anchor="middle" fill="#8C1D40" font-family="Arial, sans-serif">Analysis Graph</text>
  </g>
  ...
  <g id="ag-step-scanner" style="opacity:0;">
    ...
    <rect x="40" y="245" width="200" height="130" rx="6" fill="#fafafa00" stroke="#2196F3" stroke-width="2"/>
    <text x="140" y="265" font-size="15.2" font-weight="bold" text-anchor="middle" fill="#1565C0" font-family="Arial, sans-serif">POI Created</text>
    <text x="58" y="298" font-size="15.2" fill="#333" font-family="Arial, sans-serif">Function: X</text>
    <text x="58" y="318" font-size="15.2" fill="#333" font-family="Arial, sans-serif">Evidence: 1</text>
    <text x="58" y="342" font-size="15.2" fill="#2196F3" font-weight="600" font-family="Arial, sans-serif">Signal: suspicious</text>
    <!-- Confidence bar -->
  ...
  <g id="ag-step-fuzzer" style="opacity:0;">
    ...
    <rect x="295" y="245" width="200" height="130" rx="6" fill="#fafafa00" stroke="#FF9800" stroke-width="2"/>
    <text x="395" y="265" font-size="15.2" font-weight="bold" text-anchor="middle" fill="#E65100" font-family="Arial, sans-serif">POI Updated</text>
    <text x="313" y="298" font-size="15.2" fill="#333" font-family="Arial, sans-serif">Function: X</text>
    <text x="313" y="318" font-size="15.2" fill="#333" font-family="Arial, sans-serif">Evidence: 2</text>
    <text x="313" y="342" font-size="15.2" fill="#FF9800" font-weight="600" font-family="Arial, sans-serif">+ crash detected</text>
    <!-- Confidence bar -->
  ...
  <g id="ag-step-rca" style="opacity:0;">
    ...
    <rect x="550" y="245" width="200" height="130" rx="6" fill="#fafafa00" stroke="#4CAF50" stroke-width="2"/>
    <text x="650" y="265" font-size="15.2" font-weight="bold" text-anchor="middle" fill="#2E7D32" font-family="Arial, sans-serif">POI Diagnosed</text>
    <text x="568" y="298" font-size="15.2" fill="#333" font-family="Arial, sans-serif">Function: X</text>
    <text x="568" y="318" font-size="15.2" fill="#333" font-family="Arial, sans-serif">Evidence: 3</text>
    <text x="568" y="342" font-size="15.2" fill="#4CAF50" font-weight="600" font-family="Arial, sans-serif">+ buffer overflow L42</text>
    <!-- Confidence bar -->
  ...
  <g id="ag-step-patcher" style="opacity:0;">
    ...
    <rect x="805" y="245" width="200" height="130" rx="6" fill="#fafafa00" stroke="#8C1D40" stroke-width="2"/>
    <text x="905" y="265" font-size="15.2" font-weight="bold" text-anchor="middle" fill="#8C1D40" font-family="Arial, sans-serif">POI Complete</text>
    <text x="823" y="298" font-size="15.2" fill="#333" font-family="Arial, sans-serif">Function: X</text>
    <text x="823" y="318" font-size="15.2" fill="#333" font-family="Arial, sans-serif">Evidence: 4</text>
    <text x="823" y="342" font-size="15.2" fill="#8C1D40" font-weight="600" font-family="Arial, sans-serif">+ patch validated</text>
    <!-- Confidence bar -->
    <rect x="823" y="354" width="164" height="8" rx="4" fill="#e0e0e0"/>
    <rect x="823" y="354" width="164" height="8" rx="4" fill="#8C1D40"/>

    <!-- Bottom insight text -->
    <text x="525" y="420" font-size="17.5" text-anchor="middle" fill="#333" font-family="Arial, sans-serif">Each agent contributes evidence independently, accumulating knowledge across techniques.</text>
  </g>
