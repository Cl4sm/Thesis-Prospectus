...
<div style="display:flex; justify-content:center; align-items:center; gap:5rem; height:82vh;">
  <div style="text-align:center;">
    <svg width="450" height="375" viewBox="0 0 120 100">
      <!-- Router body -->
    ...
    <div style="font-size:2.4rem; color:#333; margin-top:0.5rem;"><strong>Router</strong></div>
  </div>
  <div style="text-align:center;">
    <svg width="300" height="375" viewBox="0 0 80 100">
      <!-- NAS body -->
    ...
    <div style="font-size:2.4rem; color:#333; margin-top:0.5rem;"><strong>NAS</strong></div>
  </div>
  <div style="text-align:center;">
    <svg width="450" height="375" viewBox="0 0 120 100">
      <!-- Mounting bracket -->
    ...
    <div style="font-size:2.4rem; color:#333; margin-top:0.5rem;"><strong>Camera</strong></div>
  </div>
</div>
