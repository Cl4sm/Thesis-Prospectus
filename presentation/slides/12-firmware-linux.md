...
<svg viewBox="0 0 900 520" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" style="max-height: 74vh;">
  ...
  <text x="190" y="85" font-size="14" fill="#ddd" text-anchor="middle" font-family="Arial, sans-serif">web server</text>
  ...
  <text x="430" y="65" font-size="14" fill="#ddd" text-anchor="middle" font-family="Arial, sans-serif">UPnP</text>
  ...
  <text x="700" y="90" font-size="14" fill="#ddd" text-anchor="middle" font-family="Arial, sans-serif">SSH</text>
  ...
  <text x="130" y="245" font-size="14" fill="#ddd" text-anchor="middle" font-family="Arial, sans-serif">WAN config</text>
  ...
  <text x="340" y="235" font-size="14" fill="#ddd" text-anchor="middle" font-family="Arial, sans-serif">credentials</text>
  ...
  <text x="510" y="225" font-size="14" fill="#ddd" text-anchor="middle" font-family="Arial, sans-serif">network config</text>
  ...
  <text x="740" y="275" font-size="14" fill="#ddd" text-anchor="middle" font-family="Arial, sans-serif">FTP server</text>
  ...
  <text x="220" y="405" font-size="14" fill="#ddd" text-anchor="middle" font-family="Arial, sans-serif">dynamic DNS</text>
  ...
  <text x="420" y="415" font-size="14" fill="#ddd" text-anchor="middle" font-family="Arial, sans-serif">WAN monitor</text>
  ...
  <text x="590" y="395" font-size="14" fill="#ddd" text-anchor="middle" font-family="Arial, sans-serif">media server</text>
