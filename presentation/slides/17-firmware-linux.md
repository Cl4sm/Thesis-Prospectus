...
<svg viewBox="0 0 900 520" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid meet" style="max-height: 72vh;">
  ...
  <text x="190" y="85" font-size="15" fill="#ddd" text-anchor="middle" font-family="Arial, sans-serif">web server</text>
  ...
  <text x="430" y="65" font-size="15" fill="#ddd" text-anchor="middle" font-family="Arial, sans-serif">UPnP</text>
  ...
  <text x="700" y="90" font-size="15" fill="#ddd" text-anchor="middle" font-family="Arial, sans-serif">SSH</text>
  ...
  <text x="130" y="245" font-size="15" fill="#ddd" text-anchor="middle" font-family="Arial, sans-serif">WAN config</text>
  ...
  <text x="340" y="235" font-size="15" fill="#ddd" text-anchor="middle" font-family="Arial, sans-serif">credentials</text>
  ...
  <text x="510" y="225" font-size="15" fill="#ddd" text-anchor="middle" font-family="Arial, sans-serif">network config</text>
  ...
  <text x="740" y="275" font-size="15" fill="#ddd" text-anchor="middle" font-family="Arial, sans-serif">FTP server</text>
  ...
  <text x="220" y="405" font-size="15" fill="#ddd" text-anchor="middle" font-family="Arial, sans-serif">dynamic DNS</text>
  ...
  <text x="420" y="415" font-size="15" fill="#ddd" text-anchor="middle" font-family="Arial, sans-serif">WAN monitor</text>
  ...
  <text x="590" y="395" font-size="15" fill="#ddd" text-anchor="middle" font-family="Arial, sans-serif">media server</text>

  <!-- Annotation: scale callout (bottom-left) -->
  <rect x="10" y="450" width="280" height="55" rx="6" fill="white" stroke="#8C1D40" stroke-width="2" opacity="0.95"/>
  <text x="150" y="472" font-size="15" font-weight="bold" fill="#8C1D40" text-anchor="middle" font-family="Arial, sans-serif">10 binaries shown here;</text>
  <text x="150" y="494" font-size="15" fill="#333" text-anchor="middle" font-family="Arial, sans-serif">real firmware has 50–300+</text>
