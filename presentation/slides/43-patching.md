...
<svg viewBox="0 0 1100 480" style="width:100%; margin:0 auto; display:block;" xmlns="http://www.w3.org/2000/svg">
  ...
  <g id="patch-g2" class="patch-group">
    ...
    <text x="275" y="78" font-size="12" font-weight="600" text-anchor="middle" fill="#E65100" font-family="Inter, sans-serif">PoI Clusters</text>
  ...
  <g id="patch-g3" class="patch-group">
    ...
    <text x="275" y="300" font-size="11" text-anchor="middle" fill="#666" font-family="Inter, sans-serif">thought</text>
    ...
    <text x="350" y="388" font-size="11" font-weight="600" fill="#D32F2F" text-anchor="middle" font-family="Inter, sans-serif">Feedback loop</text>
  </g>
  ...
  <g id="patch-g4" class="patch-group">
    ...
    <text x="610" y="314" font-size="12" font-weight="600" fill="#2E7D32" font-family="Inter, sans-serif">FuzzPass</text>
    ...
    <text x="610" y="344" font-size="12" fill="#333" font-family="Inter, sans-serif">BypassPass</text>
  </g>
  ...
  <g id="patch-g5" class="patch-group">
    ...
    <text x="225" y="464" font-size="13" font-weight="600" text-anchor="middle" fill="#E65100" font-family="Inter, sans-serif">PatcherY: scoped, deterministic</text>

    <rect x="415" y="445" width="260" height="28" rx="4" fill="#f3e5f5"/>
