...
<svg viewBox="0 0 1000 300" style="width:100%; margin:0 auto; display:block;" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="130" y="120" font-size="13" text-anchor="middle" fill="#666">out of 63 total</text>
  ...
  <text x="380" y="120" font-size="13" text-anchor="middle" fill="#666">in real OSS projects</text>
  ...
  <text x="630" y="120" font-size="13" text-anchor="middle" fill="#666">highest of all 7 CRS teams</text>
  ...
  <text x="875" y="120" font-size="12" text-anchor="middle" fill="#666">infrastructure issues</text>

  <!-- Post-mortem section -->
  <rect x="20" y="180" width="960" height="100" fill="#fff3e0" stroke="#FF9800" stroke-width="1.5" rx="6"/>
  <text x="500" y="200" font-size="14" font-weight="bold" text-anchor="middle" fill="#E65100">Post-mortem: Infrastructure Constraints</text>

  <text x="30" y="225" font-size="13" fill="#333">Grammar agent budget hardcoded to $10 for entire 143-hour competition</text>
  <text x="30" y="245" font-size="13" fill="#333">Out-of-memory kills terminated processing on largest targets</text>
  <text x="30" y="265" font-size="13" fill="#333">Function resolver crashed without recovery of cached data</text>
</svg>
