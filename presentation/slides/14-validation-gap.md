...
<svg viewBox="0 0 1050 470" style="width:100%; display:block; margin: 0 auto;" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Source node -->
  <rect x="25" y="50" width="130" height="50" rx="6" fill="#fff3e0" stroke="#FF9800" stroke-width="2"/>
  ...
  <!-- Arrow -->
  <line x1="155" y1="75" x2="205" y2="75" stroke="#555" stroke-width="2" marker-end="url(#vg-arr)"/>
  ...
  <text x="290" y="88" font-size="11.5" text-anchor="middle" fill="#888" font-family="Inter, sans-serif">nvram_match("enable","1")</text>
  <!-- Question mark badge -->
  ...
  <rect x="60" y="185" width="420" height="240" rx="10" fill="#fafafa00" stroke="#E53935" stroke-width="2"/>
  ...
  <text x="270" y="268" font-size="13" text-anchor="middle" fill="#333" font-family="Inter, sans-serif">Vulnerability Report: command injection in dlnad</text>
  <text x="270" y="286" font-size="12" text-anchor="middle" fill="#999" font-family="Inter, sans-serif">Evidence: static dataflow trace (no PoC)</text>
  ...
  <rect x="560" y="185" width="420" height="240" rx="10" fill="#fafafa00" stroke="#2E7D32" stroke-width="2"/>
  ...
  <text x="770" y="268" font-size="13" text-anchor="middle" fill="#333" font-family="Inter, sans-serif">Vulnerability Report: command injection in dlnad</text>
  <text x="770" y="286" font-size="12" text-anchor="middle" fill="#2E7D32" font-weight="600" font-family="Inter, sans-serif">Evidence: concrete PoC exploit attached</text>
  ...
  <text x="770" y="367" font-size="13" text-anchor="middle" fill="#c8e6c9" font-family="Inter, sans-serif">Patch issued, disclosure coordinated</text>
